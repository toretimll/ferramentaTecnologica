const elements = [
    { name: "Carbono",      symbol: "C",    gif: "gifs/carbon.gif",   column: 14, row: 2, comGif: true },
    { name: "Hidrogênio",   symbol: "H",    gif: "hydrogen.gif",      column: 1,  row: 1 },
    { name: "Hélio",        symbol: "He",   gif: "helium.gif",        column: 18, row: 1 },
    { name: "Lítio",        symbol: "Li",   gif: "lithium.gif",       column: 1,  row: 2 },
    ...
    { name: "Sódio",        symbol: "Na",   gif: "sodium.gif",        column: 1,  row: 3 },
    { name: "Magnésio",     symbol: "Mg",   gif: "magnesium.gif",     column: 2,  row: 3 },
    { name: "Alumínio",     symbol: "Al",   gif: "aluminum.gif",      column: 13, row: 3 },
    ...
    { name: "Potássio",     symbol: "K",    gif: "potassium.gif",     column: 1,  row: 4 },
    { name: "Cálcio",       symbol: "Ca",   gif: "calcium.gif",       column: 2,  row: 4 },
    ...
    { name: "Cromo",        symbol: "Cr",   gif: "chromium.gif",      column: 6,  row: 4 },
    { name: "Manganês",     symbol: "Mn",   gif: "manganese.gif",     column: 7,  row: 4 },
    { name: "Ferro",        symbol: "Fe",   gif: "iron.gif",          column: 8,  row: 4 },
    { name: "Cobalto",      symbol: "Co",   gif: "cobalt.gif",        column: 9,  row: 4 },
    { name: "Níquel",       symbol: "Ni",   gif: "nickel.gif",        column: 10, row: 4 },
    { name: "Cobre",        symbol: "Cu",   gif: "copper.gif",        column: 11, row: 4 },
    { name: "Zinco",        symbol: "Zn",   gif: "zinc.gif",          column: 12, row: 4 },
    ...
    { name: "Mercúrio",     symbol: "Hg",   gif: "mercury.gif",       column: 12, row: 6 },
    { name: "Tálio",        symbol: "Tl",   gif: "thallium.gif",      column: 13, row: 6 },
    { name: "Chumbo",       symbol: "Pb",   gif: "lead.gif",          column: 14, row: 6 },
